...
def handle_chat(t,player,msg):
	...
	# GAUCHE SCROLL KULLANIMLARI
		#elif msg == "ADRUG":
		#	log("Plugin: ADVANCED DRUG KULLANILDI")
		#	inject_joymax( 0x704C,b'\x54\xED\x0E',False)
		#elif msg == "DRUG":
		#	log("Plugin: DRUG KULLANILDI")
		#	inject_joymax( 0x704C,b'\x32\xEC\x0E',False)
		#elif msg == "DAMAGEINC":
		#	log("Plugin: %20 DAMAGE INCREASE SCROLL KULLANILDI.")
		#	inject_joymax( 0x704C,b'\x4D\xED\x0E',False)
		#elif msg == "DAMAGEABS":
		#	log("Plugin: %20 DAMAGE ABSORPTION SCROLL KULLANILDI.")
		#	inject_joymax( 0x704C,b'\x4E\xED\x0E',False)
		#elif msg == "MP":
		#	log("Plugin: MP+2800 SCROLL KULLANILDI.")
		#	inject_joymax( 0x704C,b'\x4F\xED\x0E',False)
		#elif msg == "HP":
		#	log("Plugin: HP+2800 SCROLL KULLANILDI.")
		#	inject_joymax( 0x704C,b'\x50\xED\x0E',False)
		#elif msg == "RES":
		#	log("Plugin: RES SCROLL KULLANILDI")
		#	inject_joymax( 0x704C,b'\x51\xED\x36',False)		
